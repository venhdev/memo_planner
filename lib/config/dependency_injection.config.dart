...
import 'package:memo_planner/config/dependency_injection.dart' as _i50;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i11.HabitRepository>(
        _i12.HabitRepositoryImpl(gh<_i10.HabitDataSource>()));
    gh.singleton<_i13.UpdateHabitUC>(
        _i13.UpdateHabitUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i14.AddHabitUC>(_i14.AddHabitUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i15.AuthenticationDataSource>(
        _i15.AuthenticationDataSourceImpl(
      gh<_i3.FirebaseAuth>(),
      gh<_i7.GoogleSignIn>(),
      gh<_i4.FirebaseFirestore>(),
    ...
    gh.singleton<_i16.AuthenticationRepository>(
        _i17.AuthenticationRepositoryImpl(gh<_i15.AuthenticationDataSource>()));
    gh.singleton<_i18.DeleteHabitUC>(
        _i18.DeleteHabitUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i19.FireStoreTaskDataSource>(_i19.FireStoreTaskDataSourceImpl(
      gh<_i4.FirebaseFirestore>(),
      gh<_i8.LocalNotificationManager>(),
      gh<_i9.FirebaseCloudMessagingManager>(),
    ));
    gh.singleton<_i20.GetCurrentUserUC>(
        _i20.GetCurrentUserUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i21.GetHabitByHidUC>(
        _i21.GetHabitByHidUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i22.GetHabitStreamUC>(
        _i22.GetHabitStreamUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i23.GetTopStreakUC>(
        _i23.GetTopStreakUC(gh<_i11.HabitRepository>()));
    gh.singleton<_i24.GroupRepository>(
        _i25.GroupRepositoryImpl(gh<_i19.FireStoreTaskDataSource>()));
    gh.singleton<_i26.HabitInstanceDataSource>(_i26.HabitInstanceDataSourceImpl(
      gh<_i4.FirebaseFirestore>(),
      gh<_i15.AuthenticationDataSource>(),
    ));
    gh.singleton<_i27.HabitInstanceRepository>(
        _i28.HabitInstanceRepositoryImpl(gh<_i26.HabitInstanceDataSource>()));
    gh.singleton<_i29.SignInWithEmailAndPasswordUC>(
        _i29.SignInWithEmailAndPasswordUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i30.SignInWithGoogleUC>(
        _i30.SignInWithGoogleUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i31.SignOutUC>(
        _i31.SignOutUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i32.SignUpWithEmailUC>(
        _i32.SignUpWithEmailUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i33.TaskListRepository>(_i34.TaskListRepositoryImpl(
      gh<_i19.FireStoreTaskDataSource>(),
      gh<_i15.AuthenticationDataSource>(),
    ));
    gh.singleton<_i35.TaskRepository>(
        _i36.TaskRepositoryImpl(gh<_i19.FireStoreTaskDataSource>()));
    gh.singleton<_i37.UpdateDisplayNameUC>(
        _i37.UpdateDisplayNameUC(gh<_i16.AuthenticationRepository>()));
    gh.singleton<_i38.UpdateHabitInstanceUC>(
        _i38.UpdateHabitInstanceUC(gh<_i27.HabitInstanceRepository>()));
    gh.singleton<_i39.AddHabitInstanceUC>(
        _i39.AddHabitInstanceUC(gh<_i27.HabitInstanceRepository>()));
    ...
    gh.singleton<_i43.GetAllTaskStreamOfUserUC>(
        _i43.GetAllTaskStreamOfUserUC(gh<_i33.TaskListRepository>()));
    gh.singleton<_i44.GetCreateHabitInstanceByIid>(
        _i44.GetCreateHabitInstanceByIid(
      gh<_i27.HabitInstanceRepository>(),
      gh<_i11.HabitRepository>(),
    ));
    gh.singleton<_i45.GetHabitInstanceStreamUC>(
        _i45.GetHabitInstanceStreamUC(gh<_i27.HabitInstanceRepository>()));
    ...
    gh.factory<_i49.TaskBloc>(() => _i49.TaskBloc(
          gh<_i43.GetAllTaskStreamOfUserUC>(),
          gh<_i20.GetCurrentUserUC>(),
        ));
    return this;
  }
