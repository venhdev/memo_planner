...
class _HabitFormState extends State<HabitForm> {
  ...
  void onSubmitAddHabit(BuildContext context) async {
      ...
      BlocProvider.of<HabitBloc>(context).add(
        HabitEventAdd(
          habit: HabitEntity(
            ...
            reminders: Reminder(rid: generateNotificationId(_start)),
            recurrence: getRecurrenceRuleString(),
            created: DateTime.now(),
            updated: DateTime.now(),
            creator: widget.user,
            members: [widget.user.email!],
          ),
        ),
      );
    } else {
  ...
  void onSubmitEditAllHabit(BuildContext context) {
    ...
    BlocProvider.of<HabitBloc>(context).add(
      HabitEventUpdate(habit: updatedHabit),
    );
  }
}
