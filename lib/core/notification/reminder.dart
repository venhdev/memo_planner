...
class Reminder {
  ...
  factory Reminder.fromMap(Map<String, dynamic> map) {
    return Reminder(
      ...
      overrides: map['overrides'] != null ? List<OverrideReminder>.from((map['overrides'] as List<int>).map<OverrideReminder?>((x) => OverrideReminder.fromMap(x as Map<String,dynamic>),),) : null,
    );
  }
  ...
  @override
  String toString() => 'Reminder(rid: $rid, useDefault: $useDefault, overrides: $overrides)';
  ...
  @override
  int get hashCode => rid.hashCode ^ useDefault.hashCode ^ overrides.hashCode;
}
...
class OverrideReminder {
  ...
  factory OverrideReminder.fromJson(String source) => OverrideReminder.fromMap(json.decode(source) as Map<String, dynamic>);
